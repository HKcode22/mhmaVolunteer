          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                ...
                <Link href={`/enroll?program=${encodeURIComponent(programData.slug || programData.title?.toLowerCase().replace(/\s+/g, "_"))}`} className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
