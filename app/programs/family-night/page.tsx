      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mhma-gradient mhma-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif uppercase tracking-tight">
            Family <span className="text-mhma-gold italic">Night</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  A monthly community gathering bringing families together for education, food, and fun activities for all ages.
                </p>
                <p className="mb-6">
                ...
                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 font-serif">What to Expect</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Educational sessions on relevant topics</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Delicious community food and refreshments</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Fun activities for children and adults</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Opportunities to meet and connect with families</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-gray-500 text-sm mb-8 font-light">All families are welcome. Come and be part of our growing community.</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-mhma-teal p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">Monthly</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Events</p>
                </div>
                <div className="bg-mhma-dark p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">100s</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Families</p>
                </div>
              </div>
              ...
              <div className="bg-mhma-dark p-10 rounded-3xl text-white relative mhma-pattern">
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-mhma-gold">Hamid Siddiqui • Program Founder</p>
                </div>
              </div>
