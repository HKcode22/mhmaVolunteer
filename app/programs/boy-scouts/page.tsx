      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mhma-gradient mhma-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif uppercase tracking-tight">
            Boy <span className="text-mhma-gold italic">Scouts</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  Bringing out the best in our youth through scouting activities that teach real-life skills, leadership, and character development.
                </p>
                <p className="mb-6">
                ...
                <p className="mb-6">
                  We recently had our first eagle scout graduate and have several scouts in line to graduate as eagle scout. Through engaging activities and dedicated mentorship, kids are developing essential life skills, a strong sense of responsibility, and a deep appreciation for the outdoors.
                </p>
                ...
                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Outdoor survival and camping skills</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Character building and personal growth</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 font-serif">Join Scouts</h3>
                <p className="text-gray-500 text-sm mb-8 font-light">Enroll your child in our scouting program and help them develop essential life skills.</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-mhma-teal p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">14+</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Scouts</p>
                </div>
                <div className="bg-mhma-dark p-8 rounded-3xl text-center text-white shadow-lg">
                  ...
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Activities</p>
                </div>
              </div>
              ...
              <div className="bg-mhma-dark p-10 rounded-3xl text-white relative mhma-pattern">
                ...
                <p className="text-lg italic font-light mb-6 leading-relaxed">Through engaging activities and dedicated mentorship, kids are developing essential life skills and a strong sense of responsibility.</p>
                <div className="flex items-center">
                  <div className="w-10 h-0.5 bg-mhma-gold mr-4"></div>
                  <p className="text-xs font-bold uppercase tracking-widest text-mhma-gold">Vaqas Khan • Troop Leader</p>
                </div>
              </div>
