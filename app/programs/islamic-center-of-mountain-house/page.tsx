      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mhma-gradient mhma-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif uppercase tracking-tight">
            Islamic Center <span className="text-mhma-gold italic">of MH</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  Our grand vision for a center of excellence serving not just Mountain House, but the entire Bay Area and Central Valley.
                </p>
                <p className="mb-6">
                ...
                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>A state-of-the-art prayer facility</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Multipurpose halls for community events</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Educational center and library</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Sports facilities for youth programs</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Self-sustaining commercial spaces</span>
                    </li>
                  </ul>
                </div>

                <p className="mb-4">
                  <strong>Location:</strong> 250 East Main Street, Mountain House, CA 95391
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 font-serif">Support the Vision</h3>
                <p className="text-gray-500 text-sm mb-8 font-light">Your contribution helps build a permanent home for our community.</p>
                <Link href="/donate" className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-mhma-teal p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">$1M</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Fundraising Goal</p>
                </div>
                <div className="bg-mhma-dark p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">250 E</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Main Street</p>
                </div>
              </div>
