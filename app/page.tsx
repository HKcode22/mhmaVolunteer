  ...
  const loadData = async () => {
    try {
      const [eventsData, programs, masjidData, statsData, newsData] = await Promise.allSettled([
        ...
        getCachedData(`aboutStats_${statsRange}`, () => fetch(`/api/about-stats?range=${statsRange}`).then(r => r.json())).then(r => r.data),
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="lg:flex-1">
              ...
              <StatCard value={aboutStats?.donorCount ? formatCount(aboutStats.donorCount) : "—"} label="Masjid Construction Donors" color="bg-mhma-forest" />
