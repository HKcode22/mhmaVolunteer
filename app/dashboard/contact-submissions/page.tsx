                        ...
                        <tr key={i.id}>
                          <td colSpan={7} className="p-0">
                            <table className="w-full">
                              <tbody>
                                <tr className={`border-b border-gray-100 hover:bg-gray-50 transition-colors ${!i.read ? "bg-blue-50/50" : ""} ${isExpanded ? "bg-gray-50" : ""}`}>
                                  ...
                                  <td className="px-4 py-3 cursor-pointer font-semibold text-gray-900" onClick={() => setExpandedId(isExpanded ? null : i.id || null)}>{i.name}</td>
