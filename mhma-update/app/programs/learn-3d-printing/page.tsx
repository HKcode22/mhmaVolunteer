      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mhma-gradient mhma-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif uppercase tracking-tight">
            Learn <span className="text-mhma-gold italic">3D Printing</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  Learn how to design 3D objects and print them using a modern 3D Printer. Perfect for creative minds interested in technology and design.
                </p>

                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 font-serif">Program Details</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span><strong>Ages:</strong> 10 – 18 years old</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span><strong>Schedule:</strong> Sept 9th to Oct 28 (8 Sessions)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span><strong>Time:</strong> Monday, 7:00PM – 7:45PM</span>
                    </li>
                  </ul>
                </div>

                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 font-serif">Fee Structure</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>$75 MHMA member families</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>$90 for non-member families</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>$10 sibling discount available</span>
                    </li>
                  </ul>
                </div>

                <p className="mb-6">
                  Register here: <a href="https://s.mhma.info/learn3d3r" target="_blank" rel="noopener noreferrer" className="text-mhma-gold hover:underline font-medium">Interest Form</a> - Limited spaces available.
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-gray-500 text-sm mb-8 font-light">Limited spots available! Sign up your child today.</p>
                <a href="https://s.mhma.info/learn3d3r" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-mhma-teal p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">8</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Sessions</p>
                </div>
                <div className="bg-mhma-dark p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">10-18</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Age Range</p>
                </div>
              </div>
              ...
              <div className="bg-mhma-dark p-10 rounded-3xl text-white relative mhma-pattern">
                ...
                <p className="text-lg italic font-light mb-6 leading-relaxed">3D Printing is fun, and I am looking forward to sharing my knowledge on how to use it to make useful objects.</p>
                <div className="flex items-center">
                  <div className="w-10 h-0.5 bg-mhma-gold mr-4"></div>
                  <p className="text-xs font-bold uppercase tracking-widest text-mhma-gold">Umar Sear - MHMA Board President</p>
                </div>
              </div>
