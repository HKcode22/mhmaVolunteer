      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mhma-gradient mhma-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif uppercase tracking-tight">
            Learn 3D <span className="text-mhma-gold italic">Printing</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                ...
                <p className="mb-6">
                  3D Design & Printing – AGES 10 – 18
                </p>
                <p className="mb-6">
                  Sept 9th to Oct 28 (8 Sessions)
                </p>
                <p className="mb-6">
                ...
                <p className="mb-4">
                  Limited spaces available. Register via the <Link href="https://s.mhma.info/learn3d3r" target="_blank" className="text-mhma-gold hover:underline">interest form here</Link>.
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-gray-500 text-sm mb-8 font-light">Secure your spot in our 3D Design & Printing program for youth ages 10-18.</p>
                <Link href="https://s.mhma.info/learn3d3r" target="_blank" className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
                  INTEREST FORM <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-mhma-dark p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">45</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Min/Week</p>
                </div>
              </div>
              ...
              <div className="bg-mhma-dark p-10 rounded-3xl text-white relative mhma-pattern">
                ...
                <p className="text-lg italic font-light mb-6 leading-relaxed">3D Printing is fun, and I am looking forward to sharing my knowledge on how to use it to make useful objects that can be used to solve problems.</p>
