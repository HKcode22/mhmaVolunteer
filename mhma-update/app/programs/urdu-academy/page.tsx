          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  Urdu Ka Safar — Learn how to read and speak the Urdu language.
                </p>
                <p className="mb-6">
                  The Urdu Academy program teaches students the fundamentals of reading, writing, and speaking Urdu. Designed for youth and adults, the program connects students with their linguistic heritage and cultural roots.
                </p>
                <p className="mb-6">
                  Registrations are now open. The program starts in September, with orientation on the first week inshaAllah.
                </p>
                ...
                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>Urdu alphabet and reading fundamentals</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Conversational Urdu for everyday communication</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Cultural context and poetry appreciation</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Age-appropriate curriculum for all levels</span>
                    </li>
                  </ul>
                </div>

                <p className="mb-4">
                  Apply via the <Link href="https://s.mhma.info/urdu" target="_blank" className="text-mhma-gold hover:underline">application form here</Link>.
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-gray-500 text-sm mb-8 font-light">Join the Urdu Academy and connect with your linguistic heritage.</p>
                <Link href="https://s.mhma.info/urdu" target="_blank" className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
              ...
              <div className="bg-mhma-dark p-10 rounded-3xl text-white relative mhma-pattern">
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-mhma-gold">Anonymous • MHMA Member</p>
                </div>
              </div>
