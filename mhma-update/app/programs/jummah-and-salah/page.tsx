      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mhma-gradient mhma-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif uppercase tracking-tight">
            Jummah & <span className="text-mhma-gold italic">Salah</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  The Unity Center — A facility managed by MHMA for Jummah, Taraweeh, and community activities throughout the year.
                </p>
                <p className="mb-6">
                  The Unity Center is a facility owned by the City of Mountain House and managed by the Mountain House Muslim Association. The MHMA utilizes the facility for Jummah, Taraweeh, and many more activities throughout the year.
                </p>
                <p className="mb-6">
                  We hold regular daily prayers and weekly Jummah (Friday) congregational prayers with two sessions to accommodate our growing community. All members of the community are welcome to join us.
                </p>

                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 font-serif">Prayer Schedule</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Daily five prayers (Fajr, Dhuhr, Asr, Maghrib, Isha)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Jummah — 1st Session: 1:00 PM (Khutbah at 12:45 PM)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Jummah — 2nd Session: 2:00 PM (Khutbah at 1:45 PM)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Taraweeh prayers during Ramadan</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 font-serif">Visit Us</h3>
                <p className="text-gray-500 text-sm mb-8 font-light">Join us for daily prayers and weekly Jummah. Everyone is welcome.</p>
                <Link href="/contact#directions" className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-mhma-teal p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">52</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Jummah/Year</p>
                </div>
                <div className="bg-mhma-dark p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">650+</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Worshipers</p>
                </div>
              </div>
              ...
              <div className="bg-mhma-dark p-10 rounded-3xl text-white relative mhma-pattern">
                ...
                <p className="text-lg italic font-light mb-6 leading-relaxed">The Unity Center has proven to be a game-changer for our community!</p>
                <div className="flex items-center">
                  <div className="w-10 h-0.5 bg-mhma-gold mr-4"></div>
                  <p className="text-xs font-bold uppercase tracking-widest text-mhma-gold">Saqib Malik • Treasurer</p>
                </div>
              </div>
