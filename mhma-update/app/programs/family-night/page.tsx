          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-7/12">
              <div className="prose prose-lg max-w-none text-gray-700 font-light leading-relaxed">
                <p className="text-xl text-mhma-teal font-medium mb-8 border-l-4 border-mhma-gold pl-6 italic">
                  The family night is one of the first programs started by MHMA, designed to engage with the growing community and help new members feel at home.
                </p>
                ...
                <div className="my-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>Educational sessions for all ages</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
                      <span>Fun activities for the whole family</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-mhma-gold mr-3">•</span>
            ...
            <div className="lg:w-5/12 space-y-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-gray-500 text-sm mb-8 font-light">Bring your family and be part of our community gatherings!</p>
                <Link href="/register" className="flex items-center justify-center w-full py-4 bg-mhma-gold text-white font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg uppercase tracking-widest">
                  RSVP <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-mhma-teal p-8 rounded-3xl text-center text-white shadow-lg">
                  <p className="text-3xl font-bold font-serif text-mhma-gold mb-1">2017</p>
                  <p className="text-xs uppercase tracking-widest opacity-70 font-medium">Established</p>
                </div>
